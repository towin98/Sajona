...
class cosechaRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'cos_peso_verde.required'                => 'Peso verde campo es requerido.',
            'cos_peso_verde.numeric'                 => 'Peso verde campo debe ser númerico.',
            'cos_peso_verde.regex'                   => 'Peso verde campo solo puede tener 11 digitos entreros y 2 decimales máximo.',
